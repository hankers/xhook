  ...
  facade.send = function(body) {
    ...
    send = function() {
      ...
      if (request.body instanceof XHookFormData) {
        console.log("XHookFormData: ", request.body , " fd: ", request.body.fd);
        request.body = request.body.fd;
        console.log("typeof: ", getObjectClass(request.body));
...
xhook.before(function(request) {
  console.log("before:\n", request.body);
  console.log(getObjectClass(request.body));
  var type = getObjectClass(request.body);
  if (type === "File" || type === "Blob") {
     console.log("Set-Header: Enc-Test")
     request.headers['Enc-Test'] = 'test';
  }
